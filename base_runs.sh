...
# qwen3b
sbatch $EXCLUDE_NODES scripts/anvil/base_eval.sh Qwen/Qwen2.5-Omni-3B gilkeyio/librispeech-alignments test
sbatch $EXCLUDE_NODES scripts/anvil/base_eval.sh Qwen/Qwen2.5-Omni-3B enyoukai/libricount-timings test
sbatch $EXCLUDE_NODES scripts/anvil/base_eval.sh Qwen/Qwen2.5-Omni-3B enyoukai/AudioSet-Strong-Human-Sounds test

# qwen7b
sbatch $EXCLUDE_NODES scripts/anvil/base_eval.sh Qwen/Qwen2.5-Omni-7B gilkeyio/librispeech-alignments test
sbatch $EXCLUDE_NODES scripts/anvil/base_eval.sh Qwen/Qwen2.5-Omni-7B enyoukai/libricount-timings test
sbatch $EXCLUDE_NODES scripts/anvil/base_eval.sh Qwen/Qwen2.5-Omni-7B enyoukai/AudioSet-Strong-Human-Sounds test
