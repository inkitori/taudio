...
# voxtral 24b
# sbatch scripts/hyak/base_eval.sh mistralai/Voxtral-Small-24B-2507 gilkeyio/librispeech-alignments test SINGLE_WORD_TIMESTAMP_ANY
# sbatch scripts/hyak/base_eval.sh mistralai/Voxtral-Small-24B-2507 enyoukai/libricount-timings test SINGLE_WORD_TIMESTAMP_ANY
# sbatch scripts/hyak/base_eval.sh mistralai/Voxtral-Small-24B-2507 enyoukai/audioset-humans-reprocessed test SINGLE_WORD_TIMESTAMP_ANY
