...
# # qwen 7b timestamp_any tuning (epoch 8)
# # libricount
# sbatch $EXCLUDE_NODES scripts/anvil/accelerate_4_gpu_bf16_run.sh configs/qwen7b/libricount/timestamp_any/tuning/token+bidirectional_audio[start][bf16][lr_5e-6][epoch_8].yaml
# sbatch $EXCLUDE_NODES scripts/anvil/accelerate_4_gpu_bf16_run.sh configs/qwen7b/libricount/timestamp_any/tuning/poisson+bidirectional_audio[start][bias_-6.9][bf16][lr_5e-6][epoch_8].yaml
# sbatch $EXCLUDE_NODES scripts/anvil/accelerate_4_gpu_bf16_run.sh configs/qwen7b/libricount/timestamp_any/tuning/poisson+bidirectional_audio[start][bias_-6.9][bf16][lr_5e-6][epoch_8][pad_0.5].yaml
# sbatch $EXCLUDE_NODES scripts/anvil/accelerate_4_gpu_bf16_run.sh configs/qwen7b/libricount/timestamp_any/tuning/poisson+bidirectional_audio[start][bias_-6.9][bf16][upscale_4][lr_5e-6][epoch_8].yaml
# sbatch $EXCLUDE_NODES scripts/anvil/accelerate_4_gpu_bf16_run.sh configs/qwen7b/libricount/timestamp_any/tuning/poisson+bidirectional_audio[start][bias_-6.9][bf16][upscale_4][lr_5e-6][epoch_8][pad_0.5].yaml

# # audioset_humans
# sbatch $EXCLUDE_NODES scripts/anvil/accelerate_4_gpu_bf16_run.sh configs/qwen7b/audioset_humans/timestamp_any/tuning/token+bidirectional_audio[start][bf16][lr_5e-6].yaml
# sbatch $EXCLUDE_NODES scripts/anvil/accelerate_4_gpu_bf16_run.sh configs/qwen7b/audioset_humans/timestamp_any/tuning/poisson+bidirectional_audio[start][bias_-6.9][bf16][lr_5e-6][epoch_8].yaml
# sbatch $EXCLUDE_NODES scripts/anvil/accelerate_4_gpu_bf16_run.sh configs/qwen7b/audioset_humans/timestamp_any/tuning/poisson+bidirectional_audio[start][bias_-6.9][bf16][lr_5e-6][epoch_8][pad_0.5].yaml
# sbatch $EXCLUDE_NODES scripts/anvil/accelerate_4_gpu_bf16_run.sh configs/qwen7b/audioset_humans/timestamp_any/tuning/poisson+bidirectional_audio[start][bias_-6.9][bf16][upscale_4][lr_5e-6][epoch_8].yaml
# sbatch $EXCLUDE_NODES scripts/anvil/accelerate_4_gpu_bf16_run.sh configs/qwen7b/audioset_humans/timestamp_any/tuning/poisson+bidirectional_audio[start][bias_-6.9][bf16][upscale_4][lr_5e-6][epoch_8][pad_0.5].yaml

# # librispeech
# sbatch $EXCLUDE_NODES scripts/anvil/accelerate_4_gpu_bf16_run.sh configs/qwen7b/librispeech/timestamp_any/tuning/token+bidirectional_audio[start][bf16][epoch_8].yaml
...
sbatch $EXCLUDE_NODES scripts/anvil/accelerate_4_gpu_bf16_run.sh configs/qwen3b/libricount/timestamp_single/new_inference/poisson[start][bias_-6.9][bf16][upscale_4][lr_5e-6][no_schedule][epoch_3].yaml

# 1e-6 lr
sbatch $EXCLUDE_NODES scripts/anvil/accelerate_4_gpu_bf16_run.sh configs/qwen3b/libricount/timestamp_single/new_inference/token[start][bf16][lr_1e-6][no_schedule][epoch_3].yaml
sbatch $EXCLUDE_NODES scripts/anvil/accelerate_4_gpu_bf16_run.sh configs/qwen3b/libricount/timestamp_single/new_inference/poisson[start][bias_-6.9][bf16][upscale_4][lr_1e-6][no_schedule][epoch_3].yaml

# Audioset Humans

# 5e-6 lr
sbatch $EXCLUDE_NODES scripts/anvil/accelerate_4_gpu_bf16_run.sh configs/qwen3b/audioset_humans/timestamp_any/new_inference/token[start][bf16][lr_5e-6][no_schedule][epoch_3].yaml
sbatch $EXCLUDE_NODES scripts/anvil/accelerate_4_gpu_bf16_run.sh configs/qwen3b/audioset_humans/timestamp_any/new_inference/poisson[start][bias_-6.9][bf16][upscale_4][lr_5e-6][no_schedule][epoch_3].yaml

# 3e-6 lr
sbatch $EXCLUDE_NODES scripts/anvil/accelerate_4_gpu_bf16_run.sh configs/qwen3b/audioset_humans/timestamp_any/new_inference/token[start][bf16][lr_3e-6][no_schedule][epoch_3].yaml
sbatch $EXCLUDE_NODES scripts/anvil/accelerate_4_gpu_bf16_run.sh configs/qwen3b/audioset_humans/timestamp_any/new_inference/poisson[start][bias_-6.9][bf16][upscale_4][lr_3e-6][no_schedule][epoch_3].yaml
