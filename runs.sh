...
sbatch $EXCLUDE_NODES scripts/anvil/ga_accelerate_4_gpu_bf16_run.sh configs/qwen3b/librispeech/timestamp_all/poisson[start][bias_-6][bf16][upscale_4][lr_1e-6][epoch_1][no_schedule].yaml
...
# Libricount
sbatch $EXCLUDE_NODES scripts/anvil/accelerate_2_gpu_bf16_eval.sh configs/qwen3b/libricount/timestamp_any/new_inference/bernoulli[class_weighting][start][bf16][upscale_4][epoch_3][no_schedule][lr_1e-6].yaml outputs/qwen3b/libricount/timestamp_any/new_inference/bernoulli[class_weighting][start][bf16][upscale_4][epoch_3][no_schedule][lr_1e-6]/20251222_014534/checkpoint_epoch3 dev
sbatch $EXCLUDE_NODES scripts/anvil/accelerate_2_gpu_bf16_eval.sh configs/qwen3b/libricount/timestamp_any/new_inference/bernoulli[class_weighting][start][bf16][upscale_4][epoch_3][no_schedule][lr_1e-6].yaml outputs/qwen3b/libricount/timestamp_any/new_inference/bernoulli[class_weighting][start][bf16][upscale_4][epoch_3][no_schedule][lr_1e-6]/20251222_014534/checkpoint_epoch2 dev
sbatch $EXCLUDE_NODES scripts/anvil/accelerate_2_gpu_bf16_eval.sh configs/qwen3b/libricount/timestamp_any/new_inference/bernoulli[class_weighting][start][bf16][upscale_4][epoch_3][no_schedule][lr_1e-6].yaml outputs/qwen3b/libricount/timestamp_any/new_inference/bernoulli[class_weighting][start][bf16][upscale_4][epoch_3][no_schedule][lr_1e-6]/20251222_014534/checkpoint_epoch1 dev

# Audioset
sbatch $EXCLUDE_NODES scripts/anvil/accelerate_2_gpu_bf16_eval.sh configs/qwen3b/audioset_humans_resampled/timestamp_any/binary[class_weighting][start][bf16][upscale_4][lr_1e-6][epoch_3].yaml outputs/qwen3b/audioset_humans_resampled/timestamp_any/binary[class_weighting][start][bf16][upscale_4][lr_1e-6][epoch_3]/20251222_042343/checkpoint_epoch3 dev
sbatch $EXCLUDE_NODES scripts/anvil/accelerate_2_gpu_bf16_eval.sh configs/qwen3b/audioset_humans_resampled/timestamp_any/binary[class_weighting][start][bf16][upscale_4][lr_1e-6][epoch_3].yaml outputs/qwen3b/audioset_humans_resampled/timestamp_any/binary[class_weighting][start][bf16][upscale_4][lr_1e-6][epoch_3]/20251222_042343/checkpoint_epoch2 dev
sbatch $EXCLUDE_NODES scripts/anvil/accelerate_2_gpu_bf16_eval.sh configs/qwen3b/audioset_humans_resampled/timestamp_any/binary[class_weighting][start][bf16][upscale_4][lr_1e-6][epoch_3].yaml outputs/qwen3b/audioset_humans_resampled/timestamp_any/binary[class_weighting][start][bf16][upscale_4][lr_1e-6][epoch_3]/20251222_042343/checkpoint_epoch1 dev

# 7B
# Librispeech
sbatch $EXCLUDE_NODES scripts/anvil/accelerate_4_gpu_bf16_eval.sh configs/qwen7b/librispeech/timestamp_any/new_inference/bernoulli[class_weighting][start][bf16][upscale_4][epoch_3][no_schedule][lr_1e-6].yaml outputs/qwen7b/librispeech/timestamp_any/new_inference/bernoulli[class_weighting][start][bf16][upscale_4][epoch_3][no_schedule][lr_1e-6]/20251222_042342/checkpoint_epoch3 dev
sbatch $EXCLUDE_NODES scripts/anvil/accelerate_4_gpu_bf16_eval.sh configs/qwen7b/librispeech/timestamp_any/new_inference/bernoulli[class_weighting][start][bf16][upscale_4][epoch_3][no_schedule][lr_1e-6].yaml outputs/qwen7b/librispeech/timestamp_any/new_inference/bernoulli[class_weighting][start][bf16][upscale_4][epoch_3][no_schedule][lr_1e-6]/20251222_042342/checkpoint_epoch2 dev
sbatch $EXCLUDE_NODES scripts/anvil/accelerate_4_gpu_bf16_eval.sh configs/qwen7b/librispeech/timestamp_any/new_inference/bernoulli[class_weighting][start][bf16][upscale_4][epoch_3][no_schedule][lr_1e-6].yaml outputs/qwen7b/librispeech/timestamp_any/new_inference/bernoulli[class_weighting][start][bf16][upscale_4][epoch_3][no_schedule][lr_1e-6]/20251222_042342/checkpoint_epoch1 dev

# Libricount
sbatch $EXCLUDE_NODES scripts/anvil/accelerate_4_gpu_bf16_eval.sh configs/qwen7b/libricount/timestamp_any/new_inference/bernoulli[class_weighting][start][bf16][upscale_4][epoch_6][no_schedule][lr_1e-6].yaml outputs/qwen7b/libricount/timestamp_any/new_inference/bernoulli[class_weighting][start][bf16][upscale_4][epoch_6][no_schedule][lr_1e-6]/20251222_042342/checkpoint_epoch6 dev
