...
train_output=$(accelerate launch --config_file accelerate_configs/4_gpu_fp16.yaml accelerate_train.py --config $1 2>&1) # this also has the effect of piping all train to out, and eval to err
echo "$train_output"
