...
accelerate launch --main_process_port $MASTER_PORT --config_file accelerate_configs/2_gpu_bf16.yaml run.py --config "$1" --load-checkpoint "$2" --eval-only $EXTRA_FLAGS