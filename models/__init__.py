...
def create_adapter(model_id: str, bidirectional_audio: bool, dtype: str, scaling_factor: int):
    if model_id.lower() in {"qwen/qwen2.5-omni-3b", "qwen/qwen2.5-omni-7b"}:
        ...
        try:
            ...
            raise ImportError(f"Can't import Voxtral (might need to update transformers)")
        ...
        try:
            ...
            raise ImportError(f"Can't import Audio Flamingo (might need to update transformers)")
    else:
